...
internal ref struct QueryStringBuilder(string uri)
{
    private readonly StringBuilder _stringBuilder = new(uri);
    private bool _hasFirstParameter = false;

    public override readonly string ToString() => _stringBuilder.ToString();
